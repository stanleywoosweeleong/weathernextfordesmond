...
A single-file Progressive Web App (PWA) delivering personalized farm weather
forecasts for 3 plantation locations across Pahang and Terengganu. Bilingual
interface (中文 / English) with optional AI-generated farming briefings.

Personalized build for **Desmond Chin (陈联铕)**. Part of the WeatherNext
family of per-region agricultural weather builds.
...
On first launch the app seeds these 3 farms. They are auto-favourited and can
be renamed, edited, or deleted freely afterwards.

| English | 中文 | Coordinates |
|---|---|---|
| Kampung Chapu | 甘榜查布 | 5.17750, 102.89500 |
| Kuala Berang | 瓜拉伯浪 | 5.17250, 102.53333 |
| Sungkai | 宋溪 | 3.97889, 101.36028 |
...
```
wnext-weathernextfordesmond-202605261000
```
...
- **Storage namespace:** `weathernextfordesmond__*` keys in `localStorage`,
